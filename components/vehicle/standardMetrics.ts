...
export const STANDARD_METRICS = [
  ...
  { key: "m.obd2ecu_on", type: MetricType.BOOL },
  ...
  { key: "v.b.capacity", unit: "kWh", type: MetricType.NUMBER },
  { key: "v.b.health", type: MetricType.STRING },
  { key: "v.b.health", unit: "V", type: MetricType.NUMBER },
  ...
  { key: "v.b.range.full", unit: "km", type: MetricType.NUMBER, precision: 1 },
  ...
  { key: "v.b.12v.voltage_alert", type: MetricType.BOOL },
  ...
  { key: "v.c.power", unit: "kWh", type: MetricType.NUMBER },
  ...
  { key: "v.c.timermode", type: MetricType.BOOL },
  ...
  { key: "v.c.pilot", type: MetricType.BOOL },
  { key: "v.c.inprogress", type: MetricType.BOOL },
  ...
  { key: "v.g.timermode", type: MetricType.BOOL },
  ...
  { key: "v.g.pilot", type: MetricType.BOOL },
  { key: "v.g.inprogress", type: MetricType.NUMBER },
  { key: "v.g.limit.range", unit: "km", type: MetricType.BOOL },
  ...
  //Doors & ports metrics
  //
  { key: "v.d.fl", type: MetricType.BOOL },
  { key: "v.d.fr", type: MetricType.BOOL },
  { key: "v.d.rl", type: MetricType.BOOL },
  { key: "v.d.rr", type: MetricType.BOOL },
  { key: "v.d.chargeport", type: MetricType.BOOL },
  { key: "v.d.hood", type: MetricType.BOOL },
  { key: "v.d.trunk", type: MetricType.BOOL },

  //
  //Environmental & general vehicle state metrics
  //
  { key: "v.e.aux12", type: MetricType.BOOL },
  { key: "v.e.charging12", type: MetricType.BOOL },
  { key: "v.e.awake12", type: MetricType.BOOL },
  { key: "v.e.on", type: MetricType.BOOL },
  ...
  { key: "v.e.handbrake", type: MetricType.BOOL },
  { key: "v.e.reggenbrake", type: MetricType.BOOL },
  { key: "v.e.cooling", type: MetricType.BOOL },
  { key: "v.e.heating", type: MetricType.BOOL },
  { key: "v.e.hvac", type: MetricType.BOOL },
  { key: "v.e.locked", type: MetricType.BOOL },
  { key: "v.e.valet", type: MetricType.BOOL },
  { key: "v.e.headlights", type: MetricType.BOOL },
  { key: "v.e.alarm", type: MetricType.BOOL },
  { key: "v.e.parktime", unit: "s", type: MetricType.NUMBER, precision: 0 },
  { key: "v.e.drivetime", unit: "s", type: MetricType.NUMBER, precision: 0 },
  { key: "v.e.ctrl.login", type: MetricType.BOOL },
  { key: "v.e.ctrl.config", type: MetricType.BOOL },
  ...
  //
  { key: "v.p.gpslock", type: MetricType.BOOL },
  ...
  { key: "v.p.odometer", unit: "km", type: MetricType.NUMBER, precision: 1 },
  { key: "v.p.trip", type: MetricType.NUMBER },
